...
RUN set -uex; \
    ...
    gpg --import KEYS; \
    wget --progress=dot https://www-us.apache.org/dist/${APACHE_PROJECT_LABEL}/${APACHE_PROJECT_VERSION}/${APACHE_PROJECT_RELEASE_FILE}.asc; \
    wget --progress=dot:giga http://mirrors.gigenet.com/apache/${APACHE_PROJECT_LABEL}/${APACHE_PROJECT_VERSION}/${APACHE_PROJECT_RELEASE_FILE}; \
    gpg --batch --verify ${APACHE_PROJECT_RELEASE_FILE}.asc ${APACHE_PROJECT_RELEASE_FILE}; \
